            ...
            <div class="row justify-content-lg-between justify-content-center align-items-center">
                <div class="col-auto product__column">
                    <div class="row align-content-end justify-content-start">
                        <?if($arResult['PROPERTIES']['PRODUCT_PRICE']['VALUE']){?>
                            <div class="col-auto">
                                <span class="product-price price__new"><?=$arResult['PROPERTIES']['PRODUCT_PRICE']['VALUE']?></span>
                                <?if($arResult['PROPERTIES']['PRODUCT_OLD_PRICE']['VALUE']){?>
                                    <span class="product-price price__old"><?=$arResult['PROPERTIES']['PRODUCT_OLD_PRICE']['VALUE']?></span>
                                <?}?>
                            </div>
                        <?}?>
                    </div>
                ...
                <div class="col-auto product__column product__action">
                    <?if ($arResult['ALLOW_ADD_BASKET'] == 'Y') {?>
                        <?if (isset($_SESSION['BasketItems'][$arResult['ID']]) && $_SESSION['BasketItems'][$arResult['ID']]['quantity'] > 0) {?>
                            <button class="btn btn-primary product__btn js-init-add__product btn-added"
                                data-id="<?=$arResult['ID']?>">
                                <?=GetIconSVG('cart');?> Оформить
                            </button>
                        <?} else {?>
                            <button class="btn btn-primary product__btn js-init-add__product"
                                data-id="<?=$arResult['ID']?>">
                                <?=GetIconSVG('cart');?> В корзину
                            </button>
                        <?}?>
                    <?}?>
                    ...
                    <a href="#"
                       class="js-init-modal_show btn-btn_fill"
                       style="display: none"
                       data-product-id="<?=$arResult['ID']?>"
                       data-modal="fast_orders">Заказать</a>
                </div>
            </div>
